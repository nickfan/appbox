...
class DataRouteConf implements ArrayAccess {
    ...
    public function getConf($key = '', $default = null) {
        ...
        return Util::array_get($this->itemsConf[$driver], $item, $default);
    }
    ...
    public function setConf($key, $value) {
        ...
        if (is_null($item)) {
            ...
            Util::array_set($this->itemsConf[$driver], $item, $value);
        }
    }
    ...
    public function getScript($key = '', $default = null) {
        ...
        return Util::array_get($this->itemsScript[$driver], $item, $default);
    }
    ...
    public function setScript($key, $value) {
        ...
        if (is_null($item)) {
            ...
            Util::array_set($this->itemsScript[$driver], $item, $value);
        }
    }

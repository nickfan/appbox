...
class BoxRepository implements ArrayAccess {
    ...
    public function setUserCacheObject(BoxUsercacheInterface $userCacheObj) {
        $this->userCacheObj = $userCacheObj;
        $this->userCacheObj->setOption(array('ttl' => BoxConstants::USERCACHE_TTL_DEFAULT,));
    }

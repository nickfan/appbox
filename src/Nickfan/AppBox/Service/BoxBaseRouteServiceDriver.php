...
abstract class BoxBaseRouteServiceDriver implements BoxRouteServiceDriverInterface {

    protected static $instance = null;
    protected static $routeInstance = null;

    protected $driverKey = null;
    protected $routeKey = BoxConstants::CONF_KEY_ROOT;
    ...
    public static function parseClassNameDriverKey() {
        ...
        $shortClassName = substr(
            ...
            strrpos($className, '\\') + 1,
            -21
        ); // -21 = strlen(BoxRouteServiceDriver)
...
//        return static::$instance;
    ...
    protected function __construct(
        ...
        if (is_null($driverKey) && is_null($this->driverKey)) {
            $className = get_called_class();
            $className = substr($className, strrpos($className, '\\') + 1, -21); // -21 = strlen(BoxRouteServiceDriver)
            if (!empty($className)) {
    ...
    public function setRouteKey($routeKey = BoxConstants::CONF_KEY_ROOT) {
    ...
    public function getDriverInstanceSet($option=array(),$getAttrCallBack = null){
        ...
        switch ($option['routeMode']) {
            case BoxConstants::DATAROUTE_MODE_IDSET:
                ...
                $routeIdSet = array(
                    ...
                    'group' => isset($option['routeIdSet']['group']) ? $option['routeIdSet']['group'] : BoxConstants::CONF_LABEL_INIT,
                );
                ...
                break;
            case BoxConstants::DATAROUTE_MODE_DIRECT:
                ...
                break;
            case BoxConstants::DATAROUTE_MODE_ATTR:
            default:

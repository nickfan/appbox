...
class MongoBoxRouteServiceDriver extends BoxBaseRouteServiceDriver implements BoxRouteServiceDriverInterface {
    ...
    public function queryCount($queryStruct=array(),$option = array(), $vendorInstance = null){
        ...
        if($option['cacheCount']==true){
            !isset($conditionHash) && $conditionHash = BoxUtil::getDataHashKey(array($option['dbName'],$option['collectionName'],$queryCondition));

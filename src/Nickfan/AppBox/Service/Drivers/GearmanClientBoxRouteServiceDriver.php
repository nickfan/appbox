...
class GearmanClientBoxRouteServiceDriver extends BoxBaseRouteServiceDriver implements BoxRouteServiceDriverInterface {

    //protected static $driverKey = 'gearmanClient';
